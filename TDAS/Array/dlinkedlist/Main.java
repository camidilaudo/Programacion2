...
public class Main {
    ...
    public static void main(String[] args) {
        // Crear una instancia de la lista doblemente enlazada de tipo Integer
        ...
        try {
            lista.advanceR();  // Avanzar el cursor
            System.out.println("Después de avanzar, el elemento actual es: " + lista.getCurrent());  // Salida esperada: 50
        } catch (MyException e) {
            System.out.println(e.getMessage());
        }

        // Usar el cursor para recorrer hacia atrás
        lista.Last();  // Poner el cursor en el último elemento
        try {
            lista.advanceL();  // Avanzar el cursor hacia atrás
            System.out.println("Después de retroceder, el elemento actual es: " + lista.getCurrent());  // Salida esperada: 50
        } catch (MyException e) {
            System.out.println(e.getMessage());
        }
