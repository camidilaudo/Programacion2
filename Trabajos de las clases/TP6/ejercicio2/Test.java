...
public class Test {
	...
	public static void main(String[] args) {
		...
		Comparator<Nombre> c = new DefaultComparator<Nombre>();
		c.compare(n1, n2);
		System.out.println("Comparación entre 'Pepe' y 'Jose': " + c.compare(n1, n2));  // >0 porque 'Pepe' > 'Jose'
	...
	private static void insertar_imprimir( arbolBB<Integer> t, int x ) {
		t.insertar( x );  
		System.out.println( "t.insertar("+ x + "): " + t );  
	}
